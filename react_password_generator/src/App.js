...
const App = () => {
  ...
  const handleGeneratePassword = () => {
    if (!includeUpperCase && !includeLowerCase && !includeNumbers && !includeSymbols) {
      notify("Para gerar senha você deve marcar pelo menos uma caixa de seleção", true)
    }
    else {
      let characterList = ""
      if (includeNumbers) {
      ...
      notify("Senha gerada com sucesso!", false)
    }
    ...
    <div className="App">
      <div className="container">
        <div className="generator">
          ...
          <div className="form-group">
            <label htmlFor="uppercase-letters">Adicionar Letras Maiúsculas</label>
          ...
          <div className="form-group">
            <label htmlFor="lowercase-letters">Adicionar Letras Minúsculas</label>
